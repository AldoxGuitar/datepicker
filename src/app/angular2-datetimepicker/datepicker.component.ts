...
export class DatePicker implements OnInit, ControlValueAccessor {
    ...
    defaultSettings: Settings = {
        ...
        cal_full_days_lables: ["Domingo", "Lunes", "Martes", "Miércoles", "Jueves", "Viernes", "Sábado"],
        cal_months_labels: ['Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre'],
        cal_months_labels_short: ['Ene', 'Feb', 'Mar', 'Abr', 'May', 'Jun', 'Jul', 'Ago', 'Sep', 'Oct', 'Nov', 'Dic'],
        closeOnSelect: true,
        rangepicker: false
    }
    constructor() {
